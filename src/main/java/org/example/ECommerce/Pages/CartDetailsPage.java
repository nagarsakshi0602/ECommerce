...
public class CartDetailsPage extends BasePage {
    ...
    {
        WebElement element = driver.findElement(By.xpath("//a[normalize-space(text())='"+productTitle+"']/ancestor::tr"));
        return element.getAttribute("data-cart-item-quantity");
    }
    public Double itemsActualTotal(String productTitle)
    {
        WebElement element = driver.findElement(By.xpath("//a[normalize-space(text())='"+productTitle+"']/ancestor::td/following-sibling::td[contains(@class,'cart__final-price')]//span"));
