...
import org.example.ecommerce.utilities.readers.ConfigPropertyReader;
...
public class TestNGCustomReportListener implements IReporter {
	...
	@Override public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,String outdir) {
		try {
